...
//!
//! - **platform_wallet**: Receives platform fee percentage of total pool (entry fees + extras)
//! - **charity_wallet**: Receives charity allocation from total pool (entry fees + extras, split proportionally)
//!
